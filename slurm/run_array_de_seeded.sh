...
# --- Slurm properties ---
#SBATCH --job-name=ocd_pomdp_des
#SBATCH --nodes=1
#SBATCH --time=0-24:00:00
#SBATCH --partition general
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logs/ocd_pomdp_des_%A_%a.out
...
#   N=$(wc -l < BIC/_de_run_configs_seeded.txt)
#   sbatch --array=0-$((N-1))%15 slurm/run_array_de_seeded.sh

mapfile -t CONFIG_FILES < "${SLURM_SUBMIT_DIR}/BIC/_de_run_configs_seeded.txt"
...
srun apptainer exec \
    ...
    --env "POMDP_DE_SEEDS=${SLURM_SUBMIT_DIR}/BIC/_de_seeds.pkl" \
